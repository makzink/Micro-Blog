            ...
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <?php if(!isset($_COOKIE[$g_cookie_prefix.'ut'])){ ?>
                        <li onclick="login_signup(1);"><a href="#"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
                        <li onclick="login_signup(2);"><a href="#"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
                    <?php }else{ ?>
        		...
        		<div class="modal-dialog login_dialog" role="document" >
        			<div class="modal-content">
        				<div class="modal-header login_modal_header">
        					<button type="button" class="close" data-dismiss="modal" aria-label="Close"  onclick="login_signup_close()" ><span aria-hidden="true">&times;</span></button>
        				</div>
    ...
    function login_popup($popup=1,$login_same_page=1)
    {
        ...
        <div class="login_signup_box clearfix">
            <div class="col-sm-12 col-xs-12 login_col_right">
                <div class="login_home hidden clearfix">
                    <div class="text-center"><h4>Start contributing to the blog</h4></div><br/>
                    <div class="col-sm-12">
                        <a class="login_btn btn-1" href="javascript:void(0)" onclick="login_signup(2);">Sign In</a>
                        <a class="login_btn btn-1" href="javascript:void(0)" onclick="login_signup(1);">Register</a><br/>
                    </div><!-- login box -->
                </div><!-- Login signup box -->

                <!-- REGISTER -->
                <form class="form clearfix" method="POST" id="signup_form">
                    <div  class="signup_box hidden clearfix">
                        <a href="javascript:void(0)" class="back-btn"  onclick="login_signup(3);"><i class="glyphicon glyphicon-menu-left"></i></a>
                        ...
                        <div class="col-xs-12 col-sm-10 col-sm-offset-1 form_container">
                            <div class="input-outer-div" style="position:relative;">
                                <input type="text" class="form-control add-form-control inp_field inp_name" placeholder="Full name"  name="usr" required ><br/>
                                <span class="full-name-error hidden">Enter valid name</span>
                            </div>

                            <div class="input-outer-div" style="position:relative;">
                                <input type="text" class="form-control add-form-control inp_field inp_email" placeholder="Email ID"  name="email" required ><br/>
                            ...
                            <div class="input-outer-div" style="position:relative;">
                                ...
                                <input type="password" class="form-control add-form-control inp_field inp_pass" placeholder="Password"  name="pswd" style='margin-bottom:2px;' required>
                            ...
                            <br>
                            <input class="btn-1 continue-btn" type="submit" value="SIGNUP" onclick=""/><br/>
                        </div>

                        <div class="col-xs-12 text-center" >
                            <div class="new_to_cs">Already a member? <a href="javascript:void(0)" onclick="login_signup(2);" >Login</a></div>
                        </div>
                    </div>
                </form>
                ...
                <div  class="login_box clearfix">
                    ...
                    <form class="form clearfix" method="POST" id="login_form">
                        ...
                        <div class="col-xs-12 col-sm-10 col-sm-offset-1 form_container">
                            <div class="input-outer-div" style="position:relative;">
                                <input type="text" class="form-control add-form-control inp_field" placeholder="Email ID"  name="email"><br/>
                                <span class="email-error hidden">Enter Email</span>
                            </div>
                            <div class="input-outer-div" style="position:relative;">
                                <a class="show_pswd" onclick="changePswdType($(this))"><i class="hidden glyphicon glyphicon-eye-open"></i></a>
                                <input type="password" class="form-control add-form-control inp_field" placeholder="Password"  name="pswd"><br/>
                                <span class="pass-error hidden">Enter Password</span>
                            </div>
                            <input type="submit" class="btn-1" value="LOGIN" /><br/>
                        </div>
                        <div class="col-xs-12 text-center" >
                            <div class="new_to_cs">New to Kazmik Corp.? <a href="javascript:void(0)" onclick="login_signup(1);" >Signup</a></div>
                        </div>
                    </form>
                </div>
